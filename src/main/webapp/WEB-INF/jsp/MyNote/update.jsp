			...
			<form class="layui-form">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_name" name="title" required="" value="${myNote.title}" 
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_short_name" name="content" required="" value="${myNote.content}" 
							placeholder="请输入机构简称" lay-verify="content" autocomplete="off"
							class="layui-input">
					</div>
				</div>
