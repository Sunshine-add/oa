		...
		<div class="layui-row">
			<form class="layui-form">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_short_name" name="content" required=""
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="creat_time" name="creat_time" required=""
							placeholder="请输入加入时间"  lay-verify="creat_time" autocomplete="off"
