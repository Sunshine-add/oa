			...
			<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_id" name="id" required=""
							placeholder="请输入机构编号" lay-verify="id"  value="${branch.id }"  autocomplete="off"
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_name" name="name" required="" value="${branch.name }" 
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_short_name" name="short_name" required="" value="${branch.short_name }" 
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="come_time" name="come_time" required=""
							...
							readonly="readonly" class="layui-input"  value="<fmt:formatDate value="${branch.come_time }" pattern="yyyy-MM-dd HH:mm:ss" />" >
					</div>
				</div>
