			...
			<div class="layui-col-md12">
				<div class="layui-card">
					<div class="layui-card-body ">
						<form class="layui-form layui-col-space5">
							<div class="layui-inline layui-show-xs-block">
								<input type="text" name="sreach" placeholder="请输入员工姓名"
					...
					<div class="layui-card-header">
						...
						<button class="layui-btn" onclick="openUp('添加员工','add',600,520)">
								...
								.render({
									...
									cols : [ [ //表头
											...
											},
											{
												...
												templet : function(obj) {
													if (obj.status == 1) {
														return "<div><input type=\"checkbox\" name=\"status\" class=\"status\" lay-skin=\"switch\"  lay-filter=\"status\" lay-text=\"开启|禁用\" value='"+obj.id+"'  checked></div>";
													} else {
														return "<div><input type=\"checkbox\" name=\"status\" class=\"status\" lay-skin=\"switch\"  lay-filter=\"status\" lay-text=\"开启|禁用\" value='"+obj.id+"' ></div>";
													}
